    ...
    const fetchData = async () => {
      try {
        ...
        const [productRes, categoriesRes, brandsRes, unitsRes, taxesRes] =
          await Promise.all([
            axios.get(
              `https://fusionmastertech.com:8443/product/get/${productId}`
            ),
            ...
            axios.get(`https://fusionmastertech.com:8443/tax/getall`), // Fetch taxes
          ]);
                                            ...
                                            <tr key={variation.id}>
                                              ...
                                              <td>
                                                {variation.variationProductImages ? (
                                                  <img
                                                    src={`https://fusionmastertech.com:8443${variation.variationProductImages}`}
                                                    alt="Variation"
                                                    style={{
                                                      width: "50px",
                                                      height: "50px",
