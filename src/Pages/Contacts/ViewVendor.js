  ...
  const fetchVendorData = async () => {
    try {
      const response = await axios.get(
        `https://fusionmastertech.com:8443/business-details/get/${id}`
      );
          ...
          <div className="row">
            <div className="col-md-6">
              ...
              >
                ...
                >
                  <i className="fas fa-store me-2"></i> FUMA Shop
                </h5>
                <p className="mb-1">Dange Chowk, Pimpri Chinchwad, Pune</p>
                <p className="mb-0">MH, 411031</p>
              </div>
            </div>
            ...
            <div className="col-md-6">
              {vendor && (
                ...
                >
                  ...
                  >
                    <i className="fas fa-user-tie me-2"></i> {vendor.firmName}
                  </h5>
                  <p className="mb-1">{vendor.address}</p>
                  <p className="mb-1">
                    {vendor.city}, {vendor.state}, {vendor.country}
                  </p>
                  <p className="mb-1">Mobile: {vendor.mobileNumber}</p>
                  <p className="mb-0">Tax: {vendor.taxOrGstNumber}</p>
                </div>
              )}
            </div>
          </div>
  ...
  const renderMore = () => {
    ...
    return (
      ...
      >
        ...
        {renderRow("Active", isActive ? "Yes" : "No")}
